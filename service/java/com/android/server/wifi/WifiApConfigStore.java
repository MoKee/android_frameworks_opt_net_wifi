...
class WifiApConfigStore extends StateMachine {
    ...
    private void setDefaultApConfiguration() {
        ...
        config.SSID = mContext.getResources().getString(
                org.mokee.platform.internal.R.string.config_wifiHotSpotSsid);
        ...
        boolean set_security_none = mContext.getResources().getBoolean(
                org.mokee.platform.internal.R.bool.config_wifiHotspotSecurityNone);
        ...
        config.preSharedKey = mContext.getResources().getString(
                org.mokee.platform.internal.R.string.config_wifiHotSpotPass);
